...
const PUBLIC_ROUTE_NAMES = new Set(['pt-public-home', 'pt-member-preview', 'pt-public-consultation'])
...
router.beforeEach(async (to) => {
  ...
  if (!auth.authRequired && auth.isDemoMode) {
    const isDemoMemberRoute = to.path.startsWith('/pt/member/') && to.name !== 'pt-member-preview'
