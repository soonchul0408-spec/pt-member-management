...
<template>
  <router-view v-if="['pt-login', 'pt-role-select'].includes(route.name)" />

  <div v-else class="pt-app-shell">
    <aside class="pt-sidebar" :class="{ 'is-open': mobileMenuOpen }">
      <div class="pt-brand">
    ...
    <div class="pt-main-shell">
      <header class="pt-topbar">
        <div class="pt-topbar__left">
          <el-button class="mobile-menu-button" text @click="mobileMenuOpen = !mobileMenuOpen">☰</el-button>
          <div>
        ...
        <div class="pt-topbar__actions">
          ...
          <el-button circle plain @click="goTo('/pt/settings')">⚙</el-button>
